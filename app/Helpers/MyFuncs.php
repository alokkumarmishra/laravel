...
/* for the get the last id of the table */
    ...
    public static function uploadFile($filename, $url)
    {
        ...
        if ($filename->move(MULTIMGAGE, $file_name)) {
            return $file_name;
        } else {
            return 0;
        }
 ...
 */
    ...
    public static function resizeImage($max_width, $max_height, $source_file, $dst_dir, $quality)
    {
