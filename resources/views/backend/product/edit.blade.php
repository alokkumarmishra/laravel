...
<div class="content-wrapper">
    ...
    <section class="content">
        <div class="box box-default">
            ...
            <!-- /.box-header -->
            {{ Form::model($data,array('name'=>'add-form','id'=>'add-form','method'=>'post','url'=>"/admin/product/edit/{$data->id}",'enctype'=>'multipart/form-data'))}}
                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <div class="form-group">
                                ...
                                {{Form::hidden('image2',$data->featured_image,[])}}
                                <a href="javascript:void(0);" data-img="{{SITEURL}}data/images/{{$data->featured_image}}" class="img_how_pop"><i class="fa fa-picture-o" aria-hidden="true" data-toggle="modal"></i></a> 
    ...
    <div class="box">
        <div class="box-header with-border">
          <h3 class="box-title">Product Multiple Images</h3>
          <div class="box-tools pull-right">
