...
<section class="content">      
    <div class="box box-default">
        ...
        <form action="/admin/edit-homepage-text" method="post" enctype="multipart/form-data">
        	{{ csrf_field() }}
          <div class="row">
            <div class="col-md-6">
              ...
              <div class="form-group">
                <label>Link</label>
                <input type="text" class="form-control" value="{{$data[0]->link}}" name="link"> 
                <input type="hidden" class="form-control" value="{{$data[0]->id}}" name="id"> 
              </div>
               <div class="form-group">
                <label>Image</label>
                <input type="file" class="form-control" name="image">
                <input type="hidden" name="image2" value="{{$data[0]->header_image}}">
                <a href="javascript:void(0);" data-img="{{SITEURL}}data/images/{{$data[0]->header_image}}" class="img_how_pop"><i class="fa fa-picture-o" aria-hidden="true" data-toggle="modal"></i></a> 
              </div>             
              <!-- /.form-group -->
            </div>
            <!-- /.col -->
            <div class="col-md-6">
              <div class="form-group">
                ...
                <textarea name="sub_header" class="form-control" id="" cols="30" rows="5">{{$data[0]->sub_header}}</textarea>
              </div>
